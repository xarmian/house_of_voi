...
export type HelloWorld = {
   ...
   */
  methods:
    & Record<'hello_world()string' | 'hello_world', {
      argsObj: {
      }
      argsTuple: []
      returns: string
    }>
    & Record<'hello_you(string)string' | 'hello_you', {
      argsObj: {
        you: string
      }
      argsTuple: [you: string]
      returns: string
    }>
    & Record<'hello_you_again(string,uint64)string' | 'hello_you_again', {
      argsObj: {
        you: string
        depth: bigint | number
      }
      argsTuple: [you: string, depth: bigint | number]
      returns: string
    }>
...
export abstract class HelloWorldCallFactory {
   ...
   * @returns A TypedCallParams object for the call
   */
  static helloWorld(args: MethodArgs<'hello_world()string'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'hello_world()string' as const,
   ...
   * @returns A TypedCallParams object for the call
   */
  static helloYou(args: MethodArgs<'hello_you(string)string'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'hello_you(string)string' as const,
   ...
   * @returns A TypedCallParams object for the call
   */
  static helloYouAgain(args: MethodArgs<'hello_you_again(string,uint64)string'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'hello_you_again(string,uint64)string' as const,
...
export class HelloWorldClient {
   ...
   */
  public helloWorld(args: MethodArgs<'hello_world()string'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
   ...
   * @returns The result of the call
   */
  public helloYou(args: MethodArgs<'hello_you(string)string'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
   ...
   * @returns The result of the call
   */
  public helloYouAgain(args: MethodArgs<'hello_you_again(string,uint64)string'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
  ...
  public compose(): HelloWorldComposer {
    ...
    return {
      helloWorld(args: MethodArgs<'hello_world()string'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
        promiseChain = promiseChain.then(() => client.helloWorld(args, {...params, sendParams: {...params?.sendParams, skipSending: true, atc}}))
        resultMappers.push(undefined)
        return this
      },
      helloYou(args: MethodArgs<'hello_you(string)string'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
        promiseChain = promiseChain.then(() => client.helloYou(args, {...params, sendParams: {...params?.sendParams, skipSending: true, atc}}))
        resultMappers.push(undefined)
        return this
      },
      helloYouAgain(args: MethodArgs<'hello_you_again(string,uint64)string'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
...
export type HelloWorldComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  helloWorld(args: MethodArgs<'hello_world()string'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): HelloWorldComposer<[...TReturns, MethodReturn<'hello_world()string'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  helloYou(args: MethodArgs<'hello_you(string)string'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): HelloWorldComposer<[...TReturns, MethodReturn<'hello_you(string)string'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  helloYouAgain(args: MethodArgs<'hello_you_again(string,uint64)string'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): HelloWorldComposer<[...TReturns, MethodReturn<'hello_you_again(string,uint64)string'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  transfer(args: MethodArgs<'transfer(address)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): HelloWorldComposer<[...TReturns, MethodReturn<'transfer(address)void'>]>
