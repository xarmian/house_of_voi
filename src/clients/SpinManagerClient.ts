...
/**
 * Defines the types of available calls and state of the SpinManager smart contract.
 */
export type SpinManager = {
   ...
   */
  methods:
    & Record<'get_bet_claim_round(byte[56])uint64' | 'get_bet_claim_round', {
      argsObj: {
        betKey: Uint8Array
      }
    ...
    & Record<'spin_payline_cost()uint64' | 'spin_payline_cost', {
      argsObj: {
      }
      argsTuple: []
      returns: bigint
    ...
    & Record<'spin(uint64,uint64,uint64)byte[56]' | 'spin', {
      argsObj: {
        ...
        /**
         * The maximum payline index.
         */
        maxPaylineIndex: bigint | number
        /**
         * Player's choice of index.
         */
        index: bigint | number
      }
      argsTuple: [betAmount: bigint | number, maxPaylineIndex: bigint | number, index: bigint | number]
      /**
       * bet_key (bytes): The bet key.
       */
      returns: Uint8Array
    }>
    & Record<'spin_cost()uint64' | 'spin_cost', {
      argsObj: {
      }
      argsTuple: []
      returns: bigint
 ...
 */
export type SpinManagerSig = keyof SpinManager['methods']
/**
 * Defines an object containing all relevant parameters for a single call to the contract. Where TSignature is undefined, a bare call is made
 */
export type TypedCallParams<TSignature extends SpinManagerSig | undefined> = {
  method: TSignature
...
/**
 * Maps a method signature from the SpinManager smart contract to the method's arguments in either tuple of struct form
 */
export type MethodArgs<TSignature extends SpinManagerSig> = SpinManager['methods'][TSignature]['argsObj' | 'argsTuple']
/**
 * Maps a method signature from the SpinManager smart contract to the method's return type
 */
export type MethodReturn<TSignature extends SpinManagerSig> = SpinManager['methods'][TSignature]['returns']

/**
 * A factory for available 'create' calls
 */
export type SpinManagerCreateCalls = (typeof SpinManagerCallFactory)['create']
/**
 * Defines supported create methods for this smart contract
 */
export type SpinManagerCreateCallParams =
  | (TypedCallParams<undefined> & (OnCompleteNoOp))
/**
 * Defines arguments required for the deploy method.
 */
export type SpinManagerDeployArgs = {
  deployTimeParams?: TealTemplateParams
  /**
   * A delegate which takes a create call factory and returns the create call params for this smart contract
   */
  createCall?: (callFactory: SpinManagerCreateCalls) => SpinManagerCreateCallParams
}
 ...
 */
export abstract class SpinManagerCallFactory {
  /**
   ...
   * @returns A TypedCallParams object for the call
   */
  static getBetClaimRound(args: MethodArgs<'get_bet_claim_round(byte[56])uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'get_bet_claim_round(byte[56])uint64' as const,
   ...
   * @returns A TypedCallParams object for the call
   */
  static spinPaylineCost(args: MethodArgs<'spin_payline_cost()uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'spin_payline_cost()uint64' as const,
...
of future round.
   ...
   * @returns A TypedCallParams object for the call
   */
  static spinCost(args: MethodArgs<'spin_cost()uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'spin_cost()uint64' as const,
      methodArgs: Array.isArray(args) ? args : [],
      ...params,
    }
  }
...
export class SpinManagerClient {
   ...
   */
  public async call<TSignature extends keyof SpinManager['methods']>(typedCallParams: TypedCallParams<TSignature>, returnValueFormatter?: (value: any) => MethodReturn<TSignature>) {
   ...
   */
  public deploy(params: SpinManagerDeployArgs & AppClientDeployCoreParams = {}): ReturnType<ApplicationClient['deploy']> {
   ...
   */
  public getBetClaimRound(args: MethodArgs<'get_bet_claim_round(byte[56])uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
   ...
   * @returns The result of the call
   */
  public spinPaylineCost(args: MethodArgs<'spin_payline_cost()uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
...
of future round.
   ...
   * @returns The result of the call
   */
  public spinCost(args: MethodArgs<'spin_cost()uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
...
Only callable by contract owner
  ...
  public compose(): SpinManagerComposer {
    const client = this
    const atc = new AtomicTransactionComposer()
    let promiseChain:Promise<unknown> = Promise.resolve()
    const resultMappers: Array<undefined | ((x: any) => any)> = []
    return {
      getBetClaimRound(args: MethodArgs<'get_bet_claim_round(byte[56])uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
      ...
      spinPaylineCost(args: MethodArgs<'spin_payline_cost()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
      ...
      spinCost(args: MethodArgs<'spin_cost()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
    ...
    } as unknown as SpinManagerComposer
  }
}
export type SpinManagerComposer<TReturns extends [...any[]] = []> = {
  /**
   * Calls the get_bet_claim_round(byte[56])uint64 ABI method.
   *
   * @param args The arguments for the contract call
   ...
   */
  getBetClaimRound(args: MethodArgs<'get_bet_claim_round(byte[56])uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'get_bet_claim_round(byte[56])uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  spinPaylineCost(args: MethodArgs<'spin_payline_cost()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'spin_payline_cost()uint64'>]>
...
of future round.
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  spin(args: MethodArgs<'spin(uint64,uint64,uint64)byte[56]'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'spin(uint64,uint64,uint64)byte[56]'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  spinCost(args: MethodArgs<'spin_cost()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'spin_cost()uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  claim(args: MethodArgs<'claim(byte[56])uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'claim(byte[56])uint64'>]>
...
have already submitted the payment.
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  ownerDeposit(args: MethodArgs<'owner_deposit(uint64)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'owner_deposit(uint64)void'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  deposit(args: MethodArgs<'deposit()void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'deposit()void'>]>
...
Only callable by contract owner
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  withdraw(args: MethodArgs<'withdraw(uint64)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'withdraw(uint64)void'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getBalanceAvailable(args: MethodArgs<'get_balance_available()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'get_balance_available()uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getBalanceLocked(args: MethodArgs<'get_balance_locked()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'get_balance_locked()uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getBalanceTotal(args: MethodArgs<'get_balance_total()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'get_balance_total()uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  bootstrap(args: MethodArgs<'bootstrap()void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'bootstrap()void'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  bootstrapCost(args: MethodArgs<'bootstrap_cost()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'bootstrap_cost()uint64'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getOwner(args: MethodArgs<'get_owner()address'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'get_owner()address'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  transferOwnership(args: MethodArgs<'transfer_ownership(address)void'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, MethodReturn<'transfer_ownership(address)void'>]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  clearState(args?: BareCallArgs & AppClientComposeCallCoreParams & CoreAppCallArgs): SpinManagerComposer<[...TReturns, undefined]>
   ...
   */
  addTransaction(txn: TransactionWithSigner | TransactionToSign | Transaction | Promise<SendTransactionResult>, defaultSender?: SendTransactionFrom): SpinManagerComposer<TReturns>
  /**
   ...
   */
  simulate(options?: SimulateOptions): Promise<SpinManagerComposerSimulateResult<TReturns>>
  /**
   * Executes the transaction group and returns the results
   */
  execute(sendParams?: AppClientComposeExecuteParams): Promise<SpinManagerComposerResults<TReturns>>
}
export type SimulateOptions = Omit<ConstructorParameters<typeof modelsv2.SimulateRequest>[0], 'txnGroups'>
export type SpinManagerComposerSimulateResult<TReturns extends [...any[]]> = {
  returns: TReturns
  methodResults: ABIResult[]
  simulateResponse: modelsv2.SimulateResponse
}
export type SpinManagerComposerResults<TReturns extends [...any[]]> = {
  returns: TReturns
  groupId: string
  txIds: string[]
