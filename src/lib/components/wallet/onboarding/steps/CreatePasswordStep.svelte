<script lang="ts">
  ...
  function handleSubmit() {
    ...
    if (password.trim() !== '' && password.length < 4) {
      localError = 'Password must be at least 4 characters or empty for no password';
      return;
    }
...
<div class="px-6 py-6 space-y-6">
  <p class="text-slate-300 text-sm">
    Set a password to protect your account. You'll need this password each time you want to access your funds.
  </p>
