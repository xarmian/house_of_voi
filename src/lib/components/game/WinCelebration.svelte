<script lang="ts">
  ...
  function createShootingSymbols() {
    ...
    console.log('Creating shooting symbols:', symbolCount, 'Center:', centerX, centerY, 'Winning symbols:', winningSymbols);
    ...
    for (let i = 0; i < symbolCount; i++) {
      ...
      console.log('Symbol', i, ':', symbol.name, 'from', centerX, centerY, 'to', targetX, targetY);
    }

    shootingSymbols = newSymbols;
    console.log('Set shootingSymbols:', shootingSymbols.length);
